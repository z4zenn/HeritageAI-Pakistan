        ...
        <div className="max-w-[420px] w-full mx-auto">
            ...
            <div className="space-y-2 mb-5">
              ...
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <User className="h-[18px] w-[18px]" style={{ color: '#3D494F' }} />
                </span>
                <input
                  type="text"
                  required
            ...
            <div className="space-y-2 mb-5">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-3 flex items-center text-[#C8B89A]/50 hover:text-[#EDE9DF] cursor-pointer"
                >
                  {showConfirmPassword ? <EyeOff className="h-[18px] w-[18px]" style={{ color: '#3D494F' }} /> : <Eye className="h-[18px] w-[18px]" style={{ color: '#3D494F' }} />}
                </button>
              </div>
            </div>
          ...
          <div className="text-center mt-6">
            <p className="font-sans text-[14px] text-[#C8B89A]">
              ...
              <Link to="/login" className="font-semibold text-[#1D9E75] hover:opacity-85 transition-opacity">
                Sign in
              </Link>
            </p>
          </div>
